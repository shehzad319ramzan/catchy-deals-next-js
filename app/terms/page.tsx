      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p className="mb-2"><strong>1.1</strong> Diese Allgemeinen Geschäftsbedingungen (nachfolgend "AGB") der Grimme und Köninger GbR, (nachfolgend "Verkäufer"), gelten für alle Verträge zur Lieferung von Waren, die ein Verbraucher oder Unternehmer (nachfolgend „Kunde") mit dem Verkäufer hinsichtlich der vom Verkäufer in seinem Online-Shop dargestellten Waren abschließt. Hiermit wird der Einbeziehung von eigenen Bedingungen des Kunden widersprochen, es sei denn, es ist etwas anderes vereinbart.</p>
